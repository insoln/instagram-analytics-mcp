    ...
    inputSchema: {
      ...
      properties: {
        ...
        metrics: {
          ...
          items: { type: 'string' },
          minItems: 1,
          description: 'List of page insight metric names (e.g., page_impressions_unique, page_views_total, page_post_engagements). Use facebook_list_known_metrics to discover available metrics.',
        },
        period: {
          type: 'string',
          enum: ['day', 'week', 'days_28'],
          description: 'Period to aggregate metrics. Supported page metrics only accept day, week, or days_28.',
        },
        since: {
          type: 'string',
    ...
    inputSchema: {
      ...
      properties: {
        ...
        metrics: {
          ...
          items: { type: 'string' },
          minItems: 1,
          description: 'List of post insight metric names (e.g., post_impressions, post_engaged_users, post_clicks). Use facebook_list_known_metrics to discover available metrics.',
        },
      },
    },
  },
